...
class DataEncoder:
    def __init__(self):
        ...
        '''
        scale = 1024.
        sizes = [s / scale for s in (32, 64, 256)] # 当32改为64时，achor与label匹配的正样本数目更多
        ...
        density = [[-4,-1,1,4],[-2,2],[0]] # density for output layer1
    ...
    def nms(self, bboxes, scores, threshold=0.4):#0.5
        '''
        bboxes(tensor) [N,4]
        scores(tensor) [N,]
        '''
    ...
    def encode(self, boxes, classes, threshold=0.3):#0.35
        '''
        boxes:[num_obj, 4]
